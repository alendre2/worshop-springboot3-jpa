...
import com.cbmam.course.repositories.OrderRepository;
import com.cbmam.course.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.ESPERANDO_PAGAMENTO, u1);
